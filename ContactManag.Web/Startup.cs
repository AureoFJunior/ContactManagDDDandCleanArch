...
using ContactManag.Application.DI;
using ContactManag.Web.Filters;

namespace ContactManag.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ContactManag", Version = "v1" });
                ...
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    " Please use the pattern 'Bearer TOKEN' ",
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ContactManag");
                    c.RoutePrefix = "docs";
                });
            }
